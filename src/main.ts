import { Player, Table } from "./components/table"

function start(twoPlayerOpt: boolean): void {
...
let StartButton: HTMLInputElement = document.createElement("input");;
